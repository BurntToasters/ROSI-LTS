...
const MANIFEST = "com.burnttoasters.rosi-lts.yml";
const APP_ID = "com.burnttoasters.rosi-lts";
...
const BUNDLE_NAMES = {
  x86_64: "ROSI-LTS-Linux-x86_64.flatpak",
  aarch64: "ROSI-LTS-Linux-aarch64.flatpak",
};
...
function main() {
  ...
  switch (command) {
    ...
    default:
      console.log("ROSI-LTS Flatpak Build Script\n");
