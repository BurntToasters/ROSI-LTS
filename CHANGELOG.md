...
| :--- | :--- | :--- |
| **[Universal EXE](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/download/v3.6.3-LTS/ROSI-LTS-Windows.exe)** <br>*(Both x64 and arm64)* | **[Universal DMG](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-MacOS-universal.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-Linux-x86_64.AppImage) / [arm64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-Linux-arm64.AppImage) |
| **Other:** [x64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-Windows-x64.exe) / [arm64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-Windows-arm64.exe) | | **DEB:** [x64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-linux_amd64.deb) / [arm64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-linux_arm64.deb) |
| | | **RPM:** [x64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-linux.x86_64.rpm) / [arm64](https://github.com/BurntToasters/ROSI-LTS/releases/download/v3.6.3-LTS/ROSI-LTS-linux.aarch64.rpm) |
...
## Changes in `v3.6.3-LTS`:
* **Codebase:** Fixed issues with not removing `/dist` before compiling.
* **Codebase:** Fixed any types warnings.
